 		...
 		<div class="col-md-12 col-xs-6">
 			<div class="text">
 				<h3>Verzenden & Retourneren</h3>
 					<p>
 					Wheels Online is een groothandel in BMW onderdelen<br/>
					gevestigd aan de Essebaan 7B, 2908LJ Capelle a-d IJssel.
					<br/>
					Wij leveren overal in Nederland en België!<br/>
					Nederland - Gratis vanaf € 250,-
					<br/>	
					Bestellingen binnen Nederland worden vanaf een bestelbedrag van € 250,- binnen 2 a 3 werkdagen gratis bij u thuis geleverd met PostNL. Voor bestellingen onder de € 250,- rekenen wij € 4,95 verzendkosten. Verzendingen die door de brievenbus passen worden per brievenbuspost naar u verstuurd. Voor verzendingen per pakketdienst ontvang u een track & trace code. Grotere artikelen, zoals velgensets, worden door onze pallet bezorgdienst bij u thuis geleverd.
					<br/>
					België - € 15,-
					<br/>
					Voor bestellingen naar België bedragen de verzendkosten € 15,- per bestelling
					<br/>
					Afhalen - Gratis<br/>
					U kunt desgewenst uw bestelling afhalen bij onze winkel in Capelle a/d Ijssel. Indien u tijdens het bestellen kiest voor afhalen ontvangt u van ons bericht wanneer uw bestelling voor u klaar ligt.
					<br/>
					Aanvullende informatie
					<br/>
					Bestellingen verzonden met PostNL worden over het algemeen binnen 24 uur bij u bezorgd. Met de track & trace code kunt u een verwacht aflevertijdstip opvragen. Als u niet thuis bent kan de postbode het pakket bij de buren bezorgen of naar een postNL afhaalpunt bij u in de buurt sturen.
					<br/>
					Mocht een bestelling niet afgeleverd kunnen worden dan wordt deze naar ons terug gestuurd. Wij zullen dan contact met u opnemen voor de verdere afhandeling.
					<br/>
					...
					<br/>
					Zorgt u er bij het terugsturen voor dat u gebruik maakt van een verzendmethode met tracking code. Wij kunnen geen verantwoordelijkheid nemen voor zoekgeraakte of niet bezorgde artikelen.
					<br/>
					...
					Retourneren:
					<br/>
					Wanneer u per abuis het verkeerde artikel besteld heeft dan kunt u dit binnen de zichttermijn van 14 dagen naar ons retourneren. Voordat u een product terug stuurt dient u via onze website een retour verzoek aan te maken. Dit kunt u doen in het besteloverzicht onder mijn account.<br/>
					U dient het product vervolgens in de originele verpakking aan ons terug te sturen. Wij adviseren u gebruik te maken van een verzendmethode met track & trace. De kosten en het risico voor retourzending zijn voor u. Wij kunnen geen verantwoordelijkheid nemen voor tijdens retourzending zoekgeraakte of beschadigde producten.
					<br/>
					Wanneer u de volledige bestelling retourneert storten wij binnen 30 dagen het volledige bestelbedrag, exclusief verzendkosten, aan u terug. Wanneer u een bestelling gedeeltelijk retourneert vergoeden wij uitsluitend de productprijs.
					<br/>
					Belangrijk
					<br/>
					Goederen die speciaal voor u samengesteld of op maat gemaakt zijn kunnen niet geretourneerd worden.
