 		...
 		<div class="col-md-12 col-xs-6">
 			<div class="text">
 				<h3>Privacy Beleid</h3>
 					...
 					<br/>
					Dit privacybeleid is van toepassing op de diensten van WheelsOnline BV, U dient zich ervan bewust te zijn dat WheelsOnline BV niet verantwoordelijk is voor het privacybeleid van andere sites en bronnen. Door gebruik te maken van deze website geeft u aan het privacy beleid te accepteren.
					<br/>
					WheelsOnline BV respecteert de privacy van alle gebruikers van haar site en draagt er zorg voor dat de persoonlijke informatie die u ons verschaft vertrouwelijk wordt behandeld.
					<br/>
					Ons gebruik van verzamelde gegevens
					<br/>
					Gebruik van onze diensten
					Wanneer u zich aanmeldt voor een van onze diensten vragen we u om persoonsgegevens te verstrekken. Deze gegevens worden gebruikt om de dienst uit te kunnen voeren. De gegevens worden opgeslagen op eigen beveiligde servers van WheelsOnline BV of die van een derde partij.
					<br/>
					Communicatie
					Wanneer u e-mail of andere berichten naar ons verzendt, is het mogelijk dat we die berichten bewaren. Soms vragen wij u naar uw persoonlijke gegevens die voor de desbetreffende situatie relevant zijn. Dit maakt het mogelijk uw vragen te verwerken en uw verzoeken te beantwoorden. De gegevens worden opgeslagen op eigen beveiligde servers van 4ev of die van een derde partij.
					<br/>
					Cookies
					Wij verzamelen gegevens voor onderzoek om zo een beter inzicht te krijgen in onze klanten, zodat wij onze diensten hierop kunnen afstemmen.
					<br/>
					Deze website maakt gebruik van “cookies” (tekstbestandtjes die op uw computer worden geplaatst) om de website te helpen analyseren hoe gebruikers de site gebruiken. De door het cookie gegenereerde informatie over uw gebruik van de website kan worden overgebracht naar eigen beveiligde servers van WheelsOnline BV of die van een derde partij. Wij gebruiken deze informatie om bij te houden hoe u de website gebruikt, om rapporten over de website-activiteit op te stellen en andere diensten aan te bieden met betrekking tot website-activiteit en internetgebruik.
					<br/>
					Doeleinden
					We verzamelen of gebruiken geen informatie voor andere doeleinden dan de doeleinden die worden beschreven in dit privacybeleid tenzij we van tevoren uw toestemming hiervoor hebben verkregen.
					<br/>
					Derden
					De informatie wordt niet met derden gedeeld met uitzondering van webapplicaties welke wij gebruiken ten behoeve van onze webwinkel. Hieronder valt o.a. het nieuwsbrievensysteem.
					<br/>
					Veranderingen
					...
					<br/>Wheels Online BV
					<br/>Essebaan7
					<br/>2908lJ Capelle a/d IJssel
					<br/>
					Tel. 010-2600601
					<br/>
					Openingstijden Maandag t/m zaterdag 09.30 t/m 17.30 uur ( zon- en feestdagen gesloten )
					info@wheelsonline.nl
 			</div>
		</div>
	</div>
</div>
