	...
	<div class="container">
 		<div class="col-md-6 col-xs-6">
 			<div class="text">
 				<h3>Over ons</h3>
 					<p>
 					Wheels Online is sinds mei 2004 actief in de verkoop in personen auto velgen en banden vanuit het bedrijfspand in Capelle a/d Ijssel ( voorheen 10 jaar in Sliedrecht ) en via deze / onze webshop. Naast velgen en banden zijn wij in het bijzonder gespecialiseerd in originele BMW onderdelen. Wij verkopen uitsluitend de originele merken welke geschikt voor uw BMW, alle andere TOP merken in de markt.
 					<br/><br/>
					Wheels online
					...
					<br/>tel: 010-2600601
					<br/>mob : 06-54704101
					<br/>info@wheelsonline.nl
					<br/>
					<br/>KVK: 24361263
					<br/>BTW: NL813331109B01
					<br/>Bank: NL40RABO0385880952
					<br/>
					<br/>Openingstijden : Maandag t/m zaterdag 09.30 t/m 17.30 uur
					</p>
 			</div>
		</div>
	...
	<div id="map"></div>
    	<script>
			...
			function initMap() {
			  ...
			  var uluru = {lat:51.960209 , lng: 4.5804513};
