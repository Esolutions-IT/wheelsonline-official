    ...
    <div class="main_content">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a class="current" href="{{route('categorie')}}">Manage Categories<!--[if IE 7]><!--></a><!--<![endif]-->
                ...
                <li><a href="login.html">Manage Users<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                    <ul>
                        <li><a href="{{route('users')}}" title="">Overzicht Users</a></li>
        ...
        <div class="center_content">
            ...
            <div class="right_content">
                ...
                <form action="{{route('categorie_opslaan')}}" method='POST'>
                    {{ csrf_field() }}
                <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
                    <thead>
                    <tr>
                        <th scope="col" class="rounded-company"></th>
                        <th scope="col" class="rounded">Categorie ID</th>
                        <th scope="col" class="rounded">Categorie Naam</th>
                    ...
                    <tr>
                        ...
                        <td><a href=""><img src="{{asset('public/images/user_edit.png')}}" alt="" title="" border="0" /></a></td>
...
@endforeach
                    <tr id="addnewproduct" style="visibility: hidden; position:absolute;">
                        <td><input type="checkbox" name="" /></td>
                        <td>-</td>
                        <td><input type="text" size="25" name="categorie" placeholder="Categorie"></td>
                        <td></td>
                        <td></td>
                ...
                <a class="bt_green" onclick="additem()" style="cursor: pointer;"><span class="bt_green_lft"></span><strong>Add new item</strong><span class="bt_green_r"></span></a>
