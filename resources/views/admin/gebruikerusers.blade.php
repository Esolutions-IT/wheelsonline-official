...
<head>
    ...
    <script type="text/javascript" src="{{asset('public/js/clockp.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/js/clockh.js')}}"></script>
    ...
    <script type="text/javascript">
        ddaccordion.init({
            ...
            togglehtml: ["suffix", "<img src='{{asset('public/images/plus.gif')}}' class='statusicon' />", "<img src='{{asset('public/images/minus.gif')}}' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
    ...
    <script type="text/javascript" src="{{asset('public/js/jconfirmaction.jquery.js')}}"></script>
    <script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript" src="{{asset('public/js/niceforms.js')}}"></script>
    <link rel="stylesheet" type="text/css" media="all" href="{{asset('public/css/niceforms-default.css')}}" />
...
<div id="main_container">
    ...
    <div class="header">
        <div class="logo"><a href="#"><img src="{{asset('public/images/logo.gif')}}" alt="" title="" border="0" /></a></div>

        <div class="right_header">Welcome {{auth()->user()->name}} ({{auth()->user()->user_level}}), <a href="{{route('landing')}}">Visit site</a>  | <a href="#" class="logout">Logout</a></div>
        <div id="clock_a"></div>
    </div>
    ...
    <div class="main_content">
        ...
        <div class="menu">
            <ul>
                <li><a href="/wheelsonline/admin/0">Admin Home</a></li>
                <li><a href="{{route('categorie')}}">Manage Categories<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                </li>
                <li><a class="current" href="{{route('users')}}">Manage Users<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                    <ul>
                        <li><a href="" title="">Overzicht Users</a></li>
                        <li><a class="sub1" href="" title="">User Categories<!--[if IE 7]><!--></a><!--<![endif]-->
                            <!--[if lte IE 6]><table><tr><td><![endif]-->
                            <ul>
                                <li><a href="{{route('admin_users')}}" title="">Admin</a></li>
                                <li><a href="{{route('gebruiker_users')}}" title="">Gebruiker</a></li>
                            </ul>
                            <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                        </li>
                    </ul>
        ...
        <div class="center_content">
            ...
            <div class="left_content">
                ...
                <div class="sidebar_search">
                    <form>
                        ...
                        <input type="image" class="search_submit" src="{{asset('public/images/search.png')}}" />
                    </form>
                </div>
                ...
                <div class="sidebar_box">
                    ...
                    <div class="sidebar_box_content">
                        ...
                        <img src="{{asset('public/images/info.png')}}" alt="" title="" class="sidebar_icon_right" />
                        <p>
                ...
                <div class="sidebar_box">
                    ...
                    <div class="sidebar_box_content">
                        ...
                        <img src="{{asset('public/images/notice.png')}}" alt="" title="" class="sidebar_icon_right" />
                        <p>
                ...
                <div class="sidebar_box">
                    ...
                    <div class="sidebar_box_content">
                        ...
                        <img src="{{asset('public/images/photo.png')}}" alt="" title="" class="sidebar_icon_right" />
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                        </p>
                    </div>
            ...
            <div class="right_content">
                ...
                <form action="{{route('users_opslaan')}}" method='POST'>
                    {{ csrf_field() }}
                    <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
                        <thead>
                        <tr>
                            <th scope="col" class="rounded-company"></th>
                            <th scope="col" class="rounded">Volledige naam</th>
                            <th scope="col" class="rounded">Email</th>
                            <th scope="col" class="rounded">Telefoon</th>
                            <th scope="col" class="rounded">Datum aangemaakt</th>
                        ...
                        <tbody>
                        @foreach($gebruikerusers as $user)
                            <tr>
                                ...
                                <td><a href="{{$user->user_level}}"><img src="{{asset('public/images/user_edit.png')}}" alt="" title="" border="0" /></a></td>
                                <td><a href="#" class="ask"><img src="{{asset('public/images/trash.png')}}" alt="" title="" border="0" /></a></td>
                            </tr>
                        @endforeach
                        <tr id="addnewproduct" style="visibility: hidden; position:absolute;">
                            <td><input type="checkbox" name="" /></td>
                            <td><input type="text" size="10" name="naam" placeholder="Naam"></td>
                            <td><input type="text" size="13" name="email" placeholder="Email"></td>
                            <td><input type="text" size="9" name="telefoon" placeholder="Telefoon"></td>
                            <td></td>

                            <td><a href="#"><button type="submit" class="btn btn-link"><img src="{{asset('public/images/valid.png')}}" alt="" title="" border="0" style="width:20px;"/></button></a></td>
                            <td><a href="#" onclick="deleteitem()"><img src="{{asset('public/images/error.png')}}" alt="" title="" border="0" style="width:20px;"/></a></td>
                        </tr>
                        <script>
                            function additem() {
    ...
    <div class="footer">
        ...
        <div class="right_footer"><a href="http://indeziner.com"><img src="{{asset('public/images/indeziner_logo.gif')}}" alt="" title="" border="0" /></a></div>
