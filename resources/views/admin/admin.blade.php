    ...
    <div class="main_content">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="{{route('users')}}">Manage Users<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                    <ul>
        ...
        <div class="center_content">
            ...
            <form action="{{route('velgen_opslaan')}}" method='POST'>
                {{ csrf_field() }}
                <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
                    ...
                    <tbody>
                    @foreach($producten_velgen as $velgen_producten)
                    <tr>
                        <td><input type="checkbox" name="" /></td>
                        <td>{{$velgen_producten->product_name}}</td>
                        <td>{{$velgen_producten->aantal}}</td>
                        <td>{{$velgen_producten->prijs}}</td>
                        <td>{{$velgen_producten->created_at}}</td>

                        <td><a href="{{$velgen_producten->web_link}}"><img src="{{asset('public/images/user_edit.png')}}" alt="" title="" border="0" /></a></td>
